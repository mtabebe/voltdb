...
#include "storage/replicatabletable.h"
 ...
 */
class StreamedTable : public ReplicatableTable<MaterializedViewTriggerForStreamInsert>, public UndoQuantumReleaseInterest {
